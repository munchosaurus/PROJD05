...
public static class Constants
{
    ...
    public const float PLAYER_JUMP_FORCE = 3;
    public const float PLAYER_JUMP_COOLDOWN = 0.5f;
    public const float PLAYER_MAX_WALKING_VELOCITY = 4f;
    public const float PLAYER_MOVEMENT_ACCELERATION = 25f;
